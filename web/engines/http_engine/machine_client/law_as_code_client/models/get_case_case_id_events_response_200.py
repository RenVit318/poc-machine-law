...
T = TypeVar("T", bound="GetCaseCaseIDEventsResponse200")


@_attrs_define
class GetCaseCaseIDEventsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_case_case_id_events_response_200 = cls(
            data=data,
        )

        get_case_case_id_events_response_200.additional_properties = d
        return get_case_case_id_events_response_200
