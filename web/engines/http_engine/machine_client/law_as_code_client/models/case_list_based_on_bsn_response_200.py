...
T = TypeVar("T", bound="CaseListBasedOnBSNResponse200")


@_attrs_define
class CaseListBasedOnBSNResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        case_list_based_on_bsn_response_200 = cls(
            data=data,
        )

        case_list_based_on_bsn_response_200.additional_properties = d
        return case_list_based_on_bsn_response_200
