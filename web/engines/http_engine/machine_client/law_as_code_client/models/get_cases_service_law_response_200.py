...
T = TypeVar("T", bound="GetCasesServiceLawResponse200")


@_attrs_define
class GetCasesServiceLawResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_cases_service_law_response_200 = cls(
            data=data,
        )

        get_cases_service_law_response_200.additional_properties = d
        return get_cases_service_law_response_200
