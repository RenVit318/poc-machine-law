...
T = TypeVar("T", bound="GetEventsResponse200")


@_attrs_define
class GetEventsResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        get_events_response_200 = cls(
            data=data,
        )

        get_events_response_200.additional_properties = d
        return get_events_response_200
