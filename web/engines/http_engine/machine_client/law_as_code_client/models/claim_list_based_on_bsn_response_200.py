...
T = TypeVar("T", bound="ClaimListBasedOnBSNResponse200")


@_attrs_define
class ClaimListBasedOnBSNResponse200:
    """
    Attributes:
    ...
    def from_dict(cls: type[T], src_dict: Mapping[str, Any]) -> T:
        ...
        claim_list_based_on_bsn_response_200 = cls(
            data=data,
        )

        claim_list_based_on_bsn_response_200.additional_properties = d
        return claim_list_based_on_bsn_response_200
